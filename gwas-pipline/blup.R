...
# 工作目录路径
workspace <- "/home/liuqibao/workspace/大论文/phenotype/"
...
input <- "/home/liuqibao/workspace/大论文/phenotype/lme4_test.csv"

# 输出文件
output <- "delta_test.blup"
# 此次分析的表型位于第几列
num=4


setwd(workspace)
f <- read.table(input,header = 1,sep=',')
...
write.table(phelineblup, file=output,quote=FALSE,row.names=FALSE)
