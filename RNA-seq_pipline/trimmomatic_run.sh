...
fastaWithAdapterEtc='/home/liuqb/tools/Trimmomatic-0.38/adapters/TruSeq3-PE-2.fa'
...
#单端
#nohup trimmomatic SE -threads $t ${id}.fastq.gz ${id}_clean.fastq.gz CROP:$crop_length & 
done < $1
